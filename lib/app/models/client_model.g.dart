...
mixin _$ClienteModel on _ClienteModelBase, Store {
  ...
  final _$nameAtom = Atom(name: '_ClienteModelBase.name');
  ...
  final _$emailAtom = Atom(name: '_ClienteModelBase.email');
  ...
  final _$passwordAtom = Atom(name: '_ClienteModelBase.password');
  ...
  final _$phoneAtom = Atom(name: '_ClienteModelBase.phone');
